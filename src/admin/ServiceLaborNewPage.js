...
const ServiceLaborNewPage = () => {
    ...
    const getList = async () => {
        ...
        const res = await request("servicelabornews/getList", "get", param);
        setLoading(false);
        if (res) {
            setList(res.list);
        }
    ...
    const onClickBtnEdit = async (item) => {
        ...
        const res_image = await request("tbservicelabornews_image/" + item.id, "get");
 ...
 const fontSize = {
    ...
    const onClickBtnDelete = async (item) => {
        Modal.confirm({
            ...
            onOk: async () => {
                ...
                const res = await request("servicelabornews/delete", "delete", data);
                if (res) {
    ...
    const onFinish = async (item) => {
        ...
        var url = "servicelabornews/create"
        if (formCat.getFieldValue("id")) {
            url = "servicelabornews/update"
        }
    ...
    return (
        <MainPage loading={loading}>
            ...
            <Modal
                ...
                title={isEditMode ? "ព័ត៌មានទូទៅ | បន្ថែមថ្មី" : " ព័ត៌មានទូទៅ | កែប្រែ"}
                open={open}
...
export default ServiceLaborNewPage;
