...
const ServicePackageLaborPage = () => {
    ...
    const getList = async () => {
        ...
        try {
            const res = await request("servicepackagelabor/getList", "get", param);
            if (res) {
                setList(res.list);
            }
        } catch (error) {
    ...
    const onClickBtnDelete = (item) => {
        Modal.confirm({
            ...
            onOk: async () => {
                ...
                try {
                    const res = await request("servicepackagelabor/delete", "delete", data);
                    if (res) {
    ...
    const onFinish = async (item) => {
        ...
        const url = (id == null ? "servicepackagelabor/create" : "servicepackagelabor/update");
        try {
    ...
    return (
        <MainPage loading={loading}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', paddingBottom: 10 }}>
                <Space>
                    <div className="txt_title">សេវាមន្ទីរពិសោធន៍!</div>
            ...
            <Modal
                title={isEditMode ? "កែប្រែ | សេវាមន្ទីរពិសោធន៍" : "បន្ថែម | សេវាមន្ទីរពិសោធន៍"}
                open={open}
                maskClosable={false}
...
export default ServicePackageLaborPage;
