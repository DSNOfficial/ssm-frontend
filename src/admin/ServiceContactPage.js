...
const ServiceContactPage = () => {
    ...
    const getList = async () => {
        ...
        const res = await request("servicepartcontact/getList", "get", param);
        setLoading(false);
        if (res) {
            setList(res.list);
        }
    ...
    const onClickBtnEdit = async (item) => {
        ...
        const res_image = await request("tbservicepartcontact_image/" + item.id, "get");
    ...
    const onClickBtnDelete = async (item) => {
        Modal.confirm({
            ...
            onOk: async () => {
                ...
                const res = await request("servicepartcontact/delete", "delete", data);
                if (res) {
    ...
    const onClickBtnView = async (item) => {
        const res_image = await request("tbservicecontact_image/" + item.id, "get");
    ...
    const onFinish = async (item) => {
        ...
        var url = "servicepartcontact/create"
        if (formCat.getFieldValue("id")) {
            url = "servicepartcontact/update"
        }
    ...
    return (
        <MainPage loading={loading}>
            <div style={{ display: 'flex', justifyContent: 'space-between', paddingBottom: 10 }}>
                <Space>
                    <div className="txt_title">ទំនាក់ទំនង
</div>
            ...
            <Modal
                ...
                title={isEditMode ? "ទំនាក់ទំនង | បន្ថែមថ្មី" : " ទំនាក់ទំនង | កែប្រែ"}
                open={open}
                        ...
                        <Col span={24}>
                            <Form.Item
                                ...
                                rules={[
                                    {
                                        required: true,
                                        message: 'សូមបំពេញតំណារ Link',
                                    },
                                ]}
                            >
                                <Input style={fontSize} placeholder=" តំណរ link" />
                            </Form.Item>
                        </Col>
                    </Row>
                    <Row>
            ...
            >
                {selectedTraining && (
                  ...
                  />
                  <p>តម្លៃ: {selectedTraining.etitle}</p>
